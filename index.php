...
<head>
    ...
    <style>
        ...
        .background-video-container {
            position: fixed;
            /* Make the video fixed on the screen */
            top: 0;
            left: 0;
            width: 100%;
            height: 100%;
...
<body>
    ...
    <!-- Main Content -->
    <div class="container min-vh-50 d-flex flex-column justify-content-center mt-5">
        <div class="p-2 p-md-5 mb-4 rounded text-body-emphasis bg-dark">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 px-0">
                    ...
                    <p class="lead my-3 text-white pe-4">
                        Kami hadir untuk memberikan layanan kesehatan terbaik bagi Anda dan keluarga.
                        Dengan pelayanan yang profesional dan ramah, kami siap membantu menjaga kesehatan Anda.
                        Temukan berbagai informasi mengenai layanan kesehatan, jadwal dokter, dan tips kesehatan di
                        sini.
                        Kami berkomitmen untuk selalu memberikan perhatian dan solusi medis yang Anda butuhkan.
                    </p>
                </div>

                <!-- Kolom Gambar -->
                <div class="col-lg-6">
                    <img src="assets/images/poli1.jpg" class="img-fluid w-100 rounded" alt="Gambar Poli">
                </div>
            </div>
        </div>
        ...
        <div class="row mb-auto">
            ...
            <div class="col-md-4 mt-5 mb-5">
                <div class="card text-bg-dark position-relative">
                    ...
                    <a href="loginUser.php" class="btn btn-success position-absolute bottom-0 end-0 m-3">
            ...
            <div class="col-md-4 mt-5">
                <div class="card text-bg-dark position-relative">
                    ...
                    <a href="login.php?role=dokter" class="btn btn-primary position-absolute bottom-0 end-0 m-3">
            ...
            <div class="col-md-4 mt-5">
                <div class="card text-bg-dark position-relative">
                    ...
                    <a href="login.php?role=admin"
                        class="btn btn-warning position-absolute bottom-0 end-0 m-3 text-white">
                        Masuk sebagai Admin
                    </a>
                </div>
            </div>
            ...
            <section>
                <div class="row">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-5 mb-4">
                        ...
                        <p>
                            Poliklinik Udinus didirikan untuk memberikan fasilitas pelayanan kesehatan bagi
                            mahasiswa dan karyawan, serta masyarakat umum di lingkungan kampus. Saat ini Poliklinik
                            UDINUS menyediakan poliklinik umum dan poliklinik gigi.
                        </p>
                    </div>
            ...
            <section class="p-3 pt-0">
                <div class="row d-flex align-items-center">
                    <div class="col-md-7 col-lg-8 text-center text-md-start">
                        <div class="p-3">
                            © 2024 Copyright:
                            <a class="text-white" href="https://mdbootstrap.com/">Yohanes Dimas Pratama -
                                A11.2021.13254</a>
                        </div>
                    </div>
